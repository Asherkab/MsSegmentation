...
class Ms2016TrainingSettings(MsBaseTrainingSettings):
    ...
    def __init__(self):
        ...
        self.data_folder = "../../Datasets/MMSEG_MICCAI2016/PreprocessedTrainingData/axial_slices_dilation_0.2_label_0.3_with_soft_staple_implemented"
        ...
        self.filters = {}  # {"mask_9": {"min_open": 1}}
        self.training_mask_type = MaskTypes.STAPLE_DILATED
